            ...
            <div class="row">
                <div class="col-lg-8">
                                ...
                                <div class="col-lg-4 col-md-6 col-sm-6">
                                    <div class="product__item">
                                        ...
                                        <div class="product__item__text">
                                            ...
                                            <h5><a href="anime-details.php?anime='. $row->id .'">'. $row->name .'</a></h5>
                                        </div>
                                    </div>
                                </div>
                            ';
                    ...
                    <div class="popular__product">
                        ...
                        $rs = $con->query("SELECT * FROM animes ORDER BY views DESC LIMIT 3");
                        while ($row = $rs->fetch(PDO::FETCH_OBJ)) {
                    ...
                    <div class="recent__product">
                        ...
                        $rs = $con->query("SELECT * FROM animes ORDER BY id DESC");
                        while ($row = $rs->fetch(PDO::FETCH_OBJ)) {
